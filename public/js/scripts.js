const cardList = [
    ...
    },
    {
        ...
        description: "While fishing supports human populations across the globe and isn’t inherently harmful to the wider world, poor fishing practices can cause lasting harm. How? When more fish get harvested than current populations can produce, a deficit develops. If such deficits continue unabated, fisheries can become economically unviable, endangered, and even extinct."
    },
    {
        title: "Ocean Acidification",
        image: "images/image-7.jpg",
        link: "About Ocean Acidification",
        description: "Few laymen are aware that the ocean absorbs almost a third of the carbon dioxide released into the world. Even fewer know that increased carbon emissions can also impact water quality, altering the pH of the ocean itself. The National Oceanic and Atmospheric Administration has noted that the past 200 years has seen “approximately a 30 percent increase in [ocean] acidity,” which directly impacts so-called “shell building” creatures. Studies have linked reef bleaching, reef death, mollusk death, and ecosystem disturbance to this increasing acidification."
    },
    {
        title: "Air Pollution",
